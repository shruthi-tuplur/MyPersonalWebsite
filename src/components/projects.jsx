        ...
        <div id="projects-bus">
            ...
            <img id="strangers-things-image-bus" src="/images/strangers-things.png"/>
                ...
                <div id='project-button-div-strangers-bus'>
                   <form><button className="project-button-bus" formAction="https://github.com/shruthi-tuplur/Stranger-s_Things">Code</button></form> 
                   <form><button className="project-button-bus" formAction="https://admirable-cheesecake-aa69e4.netlify.app/">Source</button></form> 
                </div>
            </div>
